...
export class Edges {
  ...
  constructor(links: DataLink[], nodeReference: Map<number, Pos>, private scene: Scene,
  ...
  private createReference = (size: number, length: number, links: DataLink[], nodeReference: Map<number, Pos>) => {
